    ...
    <section class="cont py-20 my-10 ">
        <div class="relative z-[800] lg:w-[50%] md:w-[70%] lg:px-20 md:px-16 px-10 space-y-10">
            ...
            <div class="flex justify-between">
                ...
                <div>
                    <p class="text-white font-semibold lg:text-5xl md:text-4xl text-xl">95%</p>
                    <p class="text-gray-300 font-light md:text-md text-sm">Happy Clients</p>
                </div>
                <div>
                    <p class="text-white font-semibold lg:text-5xl md:text-4xl text-xl">33+</p>
                    <p class="text-gray-300 font-light md:text-md text-sm">Dedicated Professionals</p>
                </div>
            </div>
        </div>

    <div class="absolute z-[500] top-0 bg-[#253858] h-full opacity-75 w-full"></div>
