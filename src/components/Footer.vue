<template>
    <footer class="w-full bg-[whitesmoke] px-6">
        <div class="flex flex-wrap gap-12 w-full lg:px-16 md:px-10 py-10">
            <div class="flex flex-col gap-4 lg:w-[30%]">
                ...
                <div class="flex flex-wrap justify-between md:gap-6">
        ...
        <div>
            <p class="text-[#8D8EA3] text-center py-10 border-t">Copyright &copy; {{ year }} <span class="font-[Bimini]">~ Dervac</span> Global Services Ltd. All Rights Reserved.</p>
        </div>
    </footer>
</template>
